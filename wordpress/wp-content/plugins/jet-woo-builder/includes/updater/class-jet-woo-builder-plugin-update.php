...
require jet_woo_builder()->plugin_path( 'includes/updater/class-jet-woo-builder-base-update.php' );
 ...
 * @since 1.0.0
 */
class Jet_Woo_Builder_Plugin_Update extends Jet_Woo_Builder_Base_Update {
...
if ( ! function_exists( 'jet_woo_builder_updater' ) ) {
	function jet_woo_builder_updater() {
		return new Jet_Woo_Builder_Plugin_Update();
	}
}
