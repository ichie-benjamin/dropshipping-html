( function( $, elementorFrontend ) {
	...
	window.jetPopup = function( $popup, settings ) {
		...
		self.onHidePopupAction = function () {
			/*var $elementorVideoWidget = $( '.elementor-widget-video', $popup );

			if ( $elementorVideoWidget[0] ) {
				$elementorVideoWidget.each( function() {
					var $this         = $( this ),
						$iframe       = $( '.elementor-video-iframe', $this ),
		...
		self.renderContent = function( data ) {
			var popupData        = data || {},
				popupDefaultData = {
					loadOnce: false, // Trigger Ajax Every Time
			...
			popupData = jQuery.extend( popupData, popupDefaultData );
