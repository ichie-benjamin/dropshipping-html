				...
				apply_filters(
					...
					array(
						...
						'prevent_pro_locations' => array(
							'type'        => 'switcher',
							'parent'      => 'jet_theme_core_settings_form',
							'title'       => esc_html__( 'Prevent Pro locations registration', 'kava-extra' ),
							'description' => esc_html__( 'Prevent Elemntor Pro locations registration from JetThemeCore. Enable this if your headers/footers disappear when JetThemeCore is active', 'kava-extra' ),
