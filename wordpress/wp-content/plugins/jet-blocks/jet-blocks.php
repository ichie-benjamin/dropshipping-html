			...
			$config = array(
				...
				'strings'      => array(
					'notice_can_install_required'     => _n_noop(
						'JetBlocks for Elementor requires the following plugin: %1$s.',
						'JetBlocks for Elementor requires the following plugins: %1$s.',
						'jet-blocks'
					),
					'notice_can_install_recommended'  => _n_noop(
						'JetBlocks for Elementor recommends the following plugin: %1$s.',
						'JetBlocks for Elementor recommends the following plugins: %1$s.',
						'jet-blocks'
					),
				),
			);
